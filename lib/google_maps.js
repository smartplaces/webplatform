          ...
          infowindow.setContent(
            '<form role="form">'+
              ...
              '<div class="form-group">'+
                  ...
                  '<input class="form-control" id="title" placeholder="Enter Title" value="'+location.title+'">'+
              '</div>'+
              '<div class="form-group">'+
                  '<label for="address">Address</label>'+
                  '<input class="form-control" id="address" placeholder="Enter Address" value="'+location.address+'">'+
              '</div>'+
              '<div class="form-group">'+
                  '<label for="contacts">Contacts</label>'+
                  '<input class="form-control" id="contacts" placeholder="Enter Contacts" value="'+location.contacts+'">'+
              '</div>'+
