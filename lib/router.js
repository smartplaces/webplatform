...
Router.map(function (){
  ...
  this.route('coupon',{path:'/coupons/:_id', template:'couponPage', data: function() {return Coupons.findOne(this.params._id)}, before: function() {AccountsEntry.signInRequired(this);}});
});
