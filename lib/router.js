...
Router.map(function (){
  ...
  this.route('newbeacon',{path:'/beacons/new', template:'beaconAddPage'});
  ...
  this.route('newmessage',{path:'/messages/new', template:'messagePage'});
  ...
  this.route('newscenario',{path:'/scenarios/new', template:'scenarioPage'});
